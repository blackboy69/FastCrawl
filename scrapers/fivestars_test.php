...
class fivestars_test extends baseScrape
{
...
//..		db::query("UPDATE  raw_data set parsed=0 where parsed=1 and  type='fivestars_test' ");
//		db::query("DROP TABLE $type");	
...
//db::query("UPDATE  raw_data set parsed=0 where type='fivestars_test' and parsed=1 ");
/*db::query("DROP TABLE fivestars_test ");
*/
$r = new fivestars_test();
$r->parseCommandLine();
