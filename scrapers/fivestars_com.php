...
class fivestars_com extends baseScrape
{
...
//..		db::query("UPDATE  raw_data set parsed=0 where parsed=1 and  type='fivestars_com' ");
//		db::query("DROP TABLE $type");	

		//$this->noProxy=true;

//
		$this->loadUrlsByCity("http://www.fivestars.com/api/v2/businesses/?near=%LAT%,%LON%");
...
//db::query("UPDATE  raw_data set parsed=0 where type='fivestars_com' and parsed=1 ");
/*db::query("DROP TABLE fivestars_com ");
*/
$r = new fivestars_com();
$r->parseCommandLine();
