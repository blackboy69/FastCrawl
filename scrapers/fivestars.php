...
class fivestars extends baseScrape
{
...
//..		db::query("UPDATE  raw_data set parsed=0 where parsed=1 and  type='fivestars' ");
//		db::query("DROP TABLE $type");	
...
//db::query("UPDATE  raw_data set parsed=0 where type='fivestars' and parsed=1 ");
/*db::query("DROP TABLE fivestars ");
*/
$r = new fivestars();
$r->parseCommandLine();
