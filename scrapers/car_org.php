...
class car_org extends baseScrape
{
...
*/
db::query("DELETE FROM raw_data where type='$type' and parsed = 0 and url like 'http://www.car.org/CAR_UMS/search.do%'");
db::query("DELETE FROM load_queue where  type='$type' and url like 'http://www.car.org/CAR_UMS/search.do%");
...
//			continue;
   ...
   static function loadCallBack($url,$html,$arg3)
   {
	...
	//	if (! $thiz->checkNeedCaptcha($url,$html))
