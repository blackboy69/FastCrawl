...
class poweredby_tcs extends baseScrape
{
   ...
   public function runLoader()
   {
	...
	//	$this->proxy='127.0.0.1:9996';
		...
		//db::query("DELETE FROM raw_data where type='poweredby_tcs'   ");
		//db::query("DELETE FROM load_queue where type='poweredby_tcs'   ");
	//	db::query("DROP TABLE poweredby_tcs");
		//db::query("UPDATE  raw_data set parsed=0 where type='$type' and parsed=1");
		
		$urls = file("poweredby_tcs.txt");
		//	$urls = array;
