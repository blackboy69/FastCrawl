...
//		$this->retryEnabled=false;
	...
	//	db::query("UPDATE raw_data set parsed = 0 where type='martindale'");
		...
		db::query("UPDATE load_queue set processing = 0 where type='martindale' and processing = 1 ");
		db::query("UPDATE raw_data set parsed = 0 where type='martindale' and parsed = 1 ");	

	*/	
		db::query("DELETE FROM load_queue where type='martindale' ");
		db::query("DELETE FROM raw_data where type='martindale' ");

		
		$this->loadUrl($this->yahoo->url('This website is powered by LexisNexis® Martindale-Hubbell®'));
		$this->loadUrl($this->bing->url('This website is powered by LexisNexis® Martindale-Hubbell®'));
